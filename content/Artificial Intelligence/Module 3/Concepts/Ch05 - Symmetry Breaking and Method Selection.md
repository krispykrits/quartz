# Symmetry Breaking and Method Selection

**Source:** slides/pages 56–57.

## Definition / Core Idea
Symmetry-breaking constraints remove equivalent solutions while preserving at least one representative from each equivalence class. Solver strategy should match structure and problem regime.

## Lecture Example
With three interchangeable colors, a structural coloring has $3!=6$ name permutations; an ordering constraint can keep one representative.
