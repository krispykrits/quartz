# Global Constraints and Bounds Propagation

**Source:** slides/pages 24–28.

## Definition / Core Idea
Global constraints retain semantics that can enable stronger propagation than decomposed primitive constraints. `Alldiff`, resource bounds, and interval bounds are the main lecture examples.

## Lecture Example
Three `Alldiff` variables sharing only {green, blue} are impossible even though pairwise inequalities retain support. Sudoku naked triples are presented as Hall-set reasoning.
