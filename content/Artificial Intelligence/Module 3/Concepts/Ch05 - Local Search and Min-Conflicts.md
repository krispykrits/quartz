...
**Source:** slides/pages 43–48.

## Definition / Core Idea
Local search uses complete assignments that may violate constraints and repairs them. Min-conflicts chooses a conflicted variable and a value minimizing conflicts. Weighting, sideways moves, tabu ideas, annealing, and restarts address plateaus.

## Lecture Example
For n-queens, one queen is fixed per column and moves within its column to reduce attacking pairs. The lecture emphasizes that basic min-conflicts is incomplete.
